    ...
    this.retailSellersService.getById(this.id).subscribe((response: any) => {
      ...
      this.userFormGroup.setValue({
        firstName: this.retailSellerActual.firstName
          ...
          : '',
        lastName: this.retailSellerActual.lastName
          ? this.retailSellerActual.lastName
          : '',
        birthday: this.retailSellerActual.birthday
          ? this.retailSellerActual.birthday
          : '',
        phone: this.retailSellerActual.phone
          ? this.retailSellerActual.phone
          : '',
        email: this.retailSellerActual.email
          ? this.retailSellerActual.email
          : '',
        address: this.retailSellerActual.address
          ? this.retailSellerActual.address
          : '',
        password: this.retailSellerActual.password
          ? this.retailSellerActual.password
          : '',
        description: this.retailSellerActual.description
          ? this.retailSellerActual.description
          : '',
      });
  ...
  openDialog(): void {
    if (this.userFormGroup.valid) {
      ...
      dialogRef.afterClosed().subscribe((result: any) => {
        if (result != undefined) {
          this.retailSellersService
            .update(Number(this.id), this.retailSellerActual)
            .subscribe((response) => {
